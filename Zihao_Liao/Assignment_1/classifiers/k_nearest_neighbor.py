...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        squared_dists=(test_sq + train_sq - 2 * dot_product)
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #########################################################################
            sorted_indices = np.argsort(dists[i])  # Sort distances in ascending order
            ...
            # np.bincount returns the frequency of each label
