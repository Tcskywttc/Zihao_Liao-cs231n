...
def rmsprop(w, dw, config=None):
    ...
    gradient values to set adaptive learning rates.

    config format:
    - learning_rate: Scalar learning rate.
    - decay_rate: Scalar between 0 and 1 giving the decay rate for the
      squared gradient cache.
    - epsilon: Small scalar for numeric stability.
    ...
    ###########################################################################
    # TODO: Implement the RMSprop update rule, storing the next value of w    #
...
def adam(w, dw, config=None):
    ...
    ###########################################################################
    # TODO: Implement the Adam update rule, storing the next value of w in    #
    ...
    # 3. bias correction
    m_unbias = m / (1.0 - beta1 ** t)
    v_unbias = v / (1.0 - beta2 ** t)
